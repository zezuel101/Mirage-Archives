...
namespace Mirage.WebIngest
{
	...
	public static class MercatorTileMath
	{
		...
		// Token: 0x060000E3 RID: 227 RVA: 0x0000877D File Offset: 0x0000697D
		...
		// Token: 0x060000E5 RID: 229 RVA: 0x00008790 File Offset: 0x00006990
		public static bool HasWebCoverage(double latitude)
		{
			return Math.Abs(latitude) <= 85.0511287798066;
		}

		// Token: 0x060000E6 RID: 230 RVA: 0x000087A8 File Offset: 0x000069A8
		...
		// Token: 0x060000E7 RID: 231 RVA: 0x00008860 File Offset: 0x00006A60
		...
		// Token: 0x060000E8 RID: 232 RVA: 0x000088B8 File Offset: 0x00006AB8
		[return: TupleElementNames(new string[]
		{
			"lonMin",
			"lonMax",
		...
		// Token: 0x060000E9 RID: 233 RVA: 0x00008928 File Offset: 0x00006B28
		[return: TupleElementNames(new string[]
		{
			"u",
			"v"
		...
		/// <summary>Ground resolution in meters per pixel at a latitude — the number that makes
		...
		// Token: 0x060000EA RID: 234 RVA: 0x000089A2 File Offset: 0x00006BA2
		...
		/// <summary>Half the world circumference in meters — the EPSG:3857 origin shift.</summary>
