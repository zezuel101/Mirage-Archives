...
namespace Mirage.WebIngest
{
	...
	///
	/// Channel-agnostic (see <see cref="T:Mirage.WebIngest.MercatorGather" />): the color bake runs 3 channels, and the identical
	...
	public static class CubeTileReprojector
	{
		...
		///
		/// Walks the output SLOT (border included — §9's border over-fetches neighboring imagery so bilinear
		/// filtering across a tile edge stays seamless) on a stride, and expands each hit by its 8 neighbors so
		...
		/// a stride of a few texels cannot skip an entire 256px tile; the neighbor expansion covers the rest.
		/// </summary>
		// Token: 0x060000C5 RID: 197 RVA: 0x0000797C File Offset: 0x00005B7C
		...
		/// </summary>
		// Token: 0x060000C6 RID: 198 RVA: 0x00007B10 File Offset: 0x00005D10
