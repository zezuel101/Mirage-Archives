...
namespace Mirage.WebIngest
{
	...
	/// encoding packs meters into R·256 + G + B/256, so a single LSB of chroma error is a 25 cm step and a
	...
	/// color sits on the latency-sensitive read path". That reasoning is about the READ path, and it still
	...
	public static class PngDecoder
	{
		...
		/// </summary>
		// Token: 0x060000B1 RID: 177 RVA: 0x00006F29 File Offset: 0x00005129
		...
		// Token: 0x060000B2 RID: 178 RVA: 0x00006F34 File Offset: 0x00005134
		...
		// Token: 0x060000B3 RID: 179 RVA: 0x00006F64 File Offset: 0x00005164
		private static byte[] DecodeInternal(byte[] data, byte[] dst, out int width, out int height)
		{
			...
			if (colorType != 0)
			{
				if (colorType != 2)
				{
					if (colorType != 6)
					{
						throw new PngDecodeException(string.Format("unsupported color type {0} (palette/alpha-grey not in scope)", colorType));
					}
					num = 4;
				}
				else
		...
		// Token: 0x060000B4 RID: 180 RVA: 0x000071E7 File Offset: 0x000053E7
		...
		// Token: 0x060000B5 RID: 181 RVA: 0x00007208 File Offset: 0x00005408
		...
		// Token: 0x060000B7 RID: 183 RVA: 0x00007528 File Offset: 0x00005728
