...
namespace Mirage.WebIngest
{
	...
	/// that crosses a tile boundary simply lands in the neighbor. There is no seam to read across, and
	...
	///
	/// Channel-agnostic on purpose: color bakes 3 channels, and the same code reprojects a 1-channel DEM,
	...
	public sealed class MercatorGather
	{
		...
		// (get) Token: 0x060000B9 RID: 185 RVA: 0x00007584 File Offset: 0x00005784
		public int Zoom
		{
			get
			{
		...
		// (get) Token: 0x060000BA RID: 186 RVA: 0x0000758C File Offset: 0x0000578C
		public int Channels
		{
			get
			{
		...
		// (get) Token: 0x060000BB RID: 187 RVA: 0x00007594 File Offset: 0x00005794
		...
		// Token: 0x060000BC RID: 188 RVA: 0x000075A4 File Offset: 0x000057A4
		...
		// Token: 0x060000BD RID: 189 RVA: 0x000075F3 File Offset: 0x000057F3
		...
		// Token: 0x060000BE RID: 190 RVA: 0x00007600 File Offset: 0x00005800
		...
		// Token: 0x060000BF RID: 191 RVA: 0x00007691 File Offset: 0x00005891
		public bool Has(int x, int y)
		{
			return this.tiles.ContainsKey(MercatorGather.Key(this.WrapX(x), y));
		}

		// Token: 0x060000C0 RID: 192 RVA: 0x000076AB File Offset: 0x000058AB
		...
		///
		/// <paramref name="gx" />/<paramref name="gy" /> are in texel units where integer+0.5 is a texel center.
		...
		// Token: 0x060000C3 RID: 195 RVA: 0x00007920 File Offset: 0x00005B20
