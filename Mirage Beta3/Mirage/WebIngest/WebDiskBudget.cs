...
namespace Mirage.WebIngest
{
	...
	/// resident only when every present layer landed (§4.4). So dropping a key from the color tier but leaving
	...
	public sealed class WebDiskBudget
	{
		...
		// (get) Token: 0x06000119 RID: 281 RVA: 0x000097DE File Offset: 0x000079DE
		public long CapBytes { get; }

		// Token: 0x17000037 RID: 55
		// (get) Token: 0x0600011A RID: 282 RVA: 0x000097E6 File Offset: 0x000079E6
		...
		// (get) Token: 0x0600011B RID: 283 RVA: 0x000097F3 File Offset: 0x000079F3
		// (set) Token: 0x0600011C RID: 284 RVA: 0x000097FB File Offset: 0x000079FB
		public int TotalEvicted { get; private set; }

		// Token: 0x17000039 RID: 57
		// (get) Token: 0x0600011D RID: 285 RVA: 0x00009804 File Offset: 0x00007A04
		// (set) Token: 0x0600011E RID: 286 RVA: 0x0000980C File Offset: 0x00007A0C
		public int TotalCompactions { get; private set; }

		// Token: 0x1700003A RID: 58
		// (get) Token: 0x0600011F RID: 287 RVA: 0x00009815 File Offset: 0x00007A15
		// (set) Token: 0x06000120 RID: 288 RVA: 0x0000981D File Offset: 0x00007A1D
		public bool CapTooSmall { get; private set; }

		// Token: 0x06000121 RID: 289 RVA: 0x00009828 File Offset: 0x00007A28
		...
		// Token: 0x06000122 RID: 290 RVA: 0x00009878 File Offset: 0x00007A78
		...
		/// <summary>Refresh a tracked key's LRU stamp. Never inserts — a key the budget doesn't know about is
		/// not on disk, and adding it here would make the eviction accounting count tiles that don't exist.</summary>
		// Token: 0x06000123 RID: 291 RVA: 0x0000992C File Offset: 0x00007B2C
		public void Touch(ulong key, int frame)
		{
			int last;
			bool flag = this.lastUsed.TryGetValue(key, out last) && last != frame;
			if (flag)
			{
		...
		// Token: 0x06000124 RID: 292 RVA: 0x00009966 File Offset: 0x00007B66
		public void OnBaked(ulong key, int frame)
		{
			this.lastUsed[key] = frame;
		}

		// Token: 0x06000125 RID: 293 RVA: 0x00009978 File Offset: 0x00007B78
		...
		// Token: 0x06000128 RID: 296 RVA: 0x00009B2C File Offset: 0x00007D2C
		...
		/// </summary>
		// Token: 0x06000129 RID: 297 RVA: 0x00009D68 File Offset: 0x00007F68
