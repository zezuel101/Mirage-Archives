...
{
	/// <summary>
	/// Live stats panel for Mirage's virtual texture caches + the color-by-level / desired-level
	...
	{
		// Token: 0x0600038E RID: 910 RVA: 0x0001AA10 File Offset: 0x00018C10
		private void Awake()
		{
		...
		// Token: 0x0600038F RID: 911 RVA: 0x0001AB28 File Offset: 0x00018D28
		public void BuildUI()
		{
			...
			this.debugColorToggle = VTDebugScreenContent.BuildToggle(t, "Debug color-by-VT-level", Shader.IsKeywordEnabled("MIRAGE_VT_DEBUG"));
		...
		// Token: 0x06000390 RID: 912 RVA: 0x0001ACD0 File Offset: 0x00018ED0
		...
		// Token: 0x06000391 RID: 913 RVA: 0x0001AEF5 File Offset: 0x000190F5
		private static void OnDesiredLevelToggled(bool isOn)
		{
			Shader.SetGlobalFloat("_VTDebugMode", isOn ? 1f : 0f);
		}

		// Token: 0x06000392 RID: 914 RVA: 0x0001AF14 File Offset: 0x00019114
		...
		// Token: 0x06000393 RID: 915 RVA: 0x0001AF40 File Offset: 0x00019140
		private void Update()
		{
			bool flag = this.statsText == null;
			if (!flag)
			{
				List<BodyDebugInfo> bodies = TileStreamingManager.GetAllBodyDebugInfo();
		...
		// Token: 0x06000394 RID: 916 RVA: 0x0001B334 File Offset: 0x00019534
		...
		// Token: 0x06000395 RID: 917 RVA: 0x0001B3D4 File Offset: 0x000195D4
